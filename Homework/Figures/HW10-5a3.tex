...
% Text Node
\draw (290,12.4) node [anchor=north west][inner sep=0.75pt]    {$Y\left( e^{j\Omega }\right)$};
% Text Node
\draw (316.4,260.5) node [anchor=north west][inner sep=0.75pt]    {$0$};
% Text Node
\draw (487,41.4) node [anchor=north west][inner sep=0.75pt]    {$30k$};
% Text Node
\draw (276.43,261.87) node [anchor=north] [inner sep=0.75pt]    {$\frac{-\pi }{4}$};
% Text Node
\draw (554.1,161.95) node [anchor=north west][inner sep=0.75pt]    {$18.75k$};
% Text Node
\draw (351.88,261.14) node [anchor=north] [inner sep=0.75pt]    {$\frac{\pi }{4}$};
% Text Node
\draw (78.1,261.37) node [anchor=north] [inner sep=0.75pt]    {$\frac{-9\pi }{4}$};
% Text Node
\draw (152.27,261.37) node [anchor=north] [inner sep=0.75pt]    {$\frac{-7\pi }{4}$};
% Text Node
\draw (477.93,262.37) node [anchor=north] [inner sep=0.75pt]    {$\frac{7\pi }{4}$};
% Text Node
\draw (552.1,262.37) node [anchor=north] [inner sep=0.75pt]    {$\frac{9\pi }{4}$};
